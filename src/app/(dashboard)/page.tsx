...
export default function OverviewPage() {
  ...
  return (
    <div className="ds-page">
      ...
      {/* AI goal nudges. Lifted out of the removed "For You" sidebar
          so we keep the savings-goal recommendations even though
          the learning-progress + literacy-score panels are gone. */}
      <AIGoalSuggestions />
