...
export default function TransactionsPage() {
  ...
  const _fakeTxns: Transaction[] = [
    // This month
    { id: 'f1', type: 'income', amount: 3500, category: 'salary', date: _d(0, 1), description: 'الراتب||Salary', user_id: '' },
    { id: 'f2', type: 'expense', amount: 450, category: 'food', date: _d(0, 3), description: 'بقالة||Groceries', user_id: '' },
    { id: 'f3', type: 'expense', amount: 800, category: 'housing', date: _d(0, 1), description: 'إيجار||Rent', user_id: '' },
    { id: 'f4', type: 'expense', amount: 200, category: 'transport', date: _d(0, 5), description: 'وقود||Gas', user_id: '' },
    { id: 'f5', type: 'expense', amount: 45, category: 'entertainment', date: _d(0, 10), description: 'نتفليكس||Netflix', user_id: '' },
    { id: 'f6', type: 'expense', amount: 120, category: 'shopping', date: _d(0, 12), description: 'ملابس||Clothes', user_id: '' },
    { id: 'f7', type: 'expense', amount: 75, category: 'health', date: _d(0, 1), description: 'اشتراك نادي||Gym membership', user_id: '' },
    // Last month (same day pattern — ~30 days apart)
    { id: 'f8', type: 'income', amount: 3500, category: 'salary', date: _d(1, 1), description: 'الراتب||Salary', user_id: '' },
    { id: 'f9', type: 'expense', amount: 430, category: 'food', date: _d(1, 3), description: 'بقالة||Groceries', user_id: '' },
    { id: 'f10', type: 'expense', amount: 800, category: 'housing', date: _d(1, 1), description: 'إيجار||Rent', user_id: '' },
    { id: 'f11', type: 'expense', amount: 190, category: 'transport', date: _d(1, 5), description: 'وقود||Gas', user_id: '' },
    { id: 'f12', type: 'expense', amount: 45, category: 'entertainment', date: _d(1, 10), description: 'نتفليكس||Netflix', user_id: '' },
    { id: 'f13', type: 'expense', amount: 75, category: 'health', date: _d(1, 1), description: 'اشتراك نادي||Gym membership', user_id: '' },
    // 2 months ago
    { id: 'f14', type: 'income', amount: 3500, category: 'salary', date: _d(2, 1), description: 'الراتب||Salary', user_id: '' },
    { id: 'f15', type: 'expense', amount: 470, category: 'food', date: _d(2, 3), description: 'بقالة||Groceries', user_id: '' },
    { id: 'f16', type: 'expense', amount: 800, category: 'housing', date: _d(2, 1), description: 'إيجار||Rent', user_id: '' },
    { id: 'f17', type: 'expense', amount: 45, category: 'entertainment', date: _d(2, 10), description: 'نتفليكس||Netflix', user_id: '' },
    { id: 'f18', type: 'expense', amount: 75, category: 'health', date: _d(2, 1), description: 'اشتراك نادي||Gym membership', user_id: '' },
  ];
