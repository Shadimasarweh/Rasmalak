    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: 'calc(100vh - 80px)', padding: 'var(--spacing-3)', direction: isRTL ? 'rtl' : 'ltr' }}>
      ...
      <div style={{ marginBottom: 'var(--spacing-3)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: 'var(--radius-sm)', background: 'rgba(16, 185, 129, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-brand-emerald)', flexShrink: 0 }}>
            <HomeIcon />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="col-span-1 lg:col-span-6">
          <div className="card-standard" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-1)' }}>
          ...
          {result ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-2)' }}>
              <div className="card-standard" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-2)' }}>
                ...
                {/* Hero Result */}
                <div style={{ padding: '1rem 1.25rem', borderRadius: 'var(--radius-card)', background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.08) 0%, rgba(16, 185, 129, 0.03) 100%)', border: '1px solid rgba(16, 185, 129, 0.2)', textAlign: 'center' }}>
                  <p style={{ fontSize: '0.75rem', color: 'var(--theme-text-muted)', marginBottom: '4px' }}>
                    {t('home_afford_max_price', 'Maximum Home Price')}
                  </p>
                  <p style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-brand-emerald)' }}>
            ...
            <div className="card-standard" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '400px', gap: '16px' }}>
              <div style={{ width: '80px', height: '80px', borderRadius: 'var(--radius-card)', background: 'rgba(16, 185, 129, 0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-brand-emerald)' }}>
                <HomeIcon />
              </div>
