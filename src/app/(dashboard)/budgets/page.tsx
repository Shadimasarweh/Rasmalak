...
export default function BudgetsPage() {
  ...
  const _fakeTransactions: Transaction[] = [
    { id: 'f1', type: 'income', amount: 3500, category: 'salary', date: new Date().toISOString(), description: 'Salary', user_id: '' },
    { id: 'f2', type: 'expense', amount: 450, category: 'food-dining', date: new Date().toISOString(), description: 'Groceries', user_id: '' },
    { id: 'f3', type: 'expense', amount: 800, category: 'housing', date: new Date().toISOString(), description: 'Rent', user_id: '' },
    { id: 'f4', type: 'expense', amount: 200, category: 'transportation', date: new Date().toISOString(), description: 'Gas', user_id: '' },
    { id: 'f5', type: 'expense', amount: 150, category: 'entertainment', date: new Date().toISOString(), description: 'Movies', user_id: '' },
    { id: 'f6', type: 'expense', amount: 120, category: 'shopping', date: new Date().toISOString(), description: 'Clothes', user_id: '' },
    { id: 'f7', type: 'expense', amount: 75, category: 'health', date: new Date().toISOString(), description: 'Pharmacy', user_id: '' },
    { id: 'f8', type: 'expense', amount: 380, category: 'food-dining', date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 15).toISOString(), description: 'Last month groceries', user_id: '' },
    { id: 'f9', type: 'expense', amount: 800, category: 'housing', date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 1).toISOString(), description: 'Last month rent', user_id: '' },
    { id: 'f10', type: 'expense', amount: 300, category: 'transportation', date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 10).toISOString(), description: 'Last month gas', user_id: '' },
    { id: 'f11', type: 'income', amount: 3500, category: 'salary', date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 1).toISOString(), description: 'Last month salary', user_id: '' },
    { id: 'f12', type: 'expense', amount: 90, category: 'entertainment', date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 20).toISOString(), description: 'Last month movies', user_id: '' },
    { id: 'f13', type: 'income', amount: 3200, category: 'salary', date: new Date(new Date().getFullYear(), new Date().getMonth() - 2, 1).toISOString(), description: '2 months ago salary', user_id: '' },
    { id: 'f14', type: 'expense', amount: 600, category: 'food-dining', date: new Date(new Date().getFullYear(), new Date().getMonth() - 2, 10).toISOString(), description: '2 months ago food', user_id: '' },
    { id: 'f15', type: 'expense', amount: 800, category: 'housing', date: new Date(new Date().getFullYear(), new Date().getMonth() - 2, 1).toISOString(), description: '2 months ago rent', user_id: '' },
    { id: 'f16', type: 'income', amount: 3200, category: 'salary', date: new Date(new Date().getFullYear(), new Date().getMonth() - 3, 1).toISOString(), description: '3 months ago salary', user_id: '' },
    { id: 'f17', type: 'expense', amount: 500, category: 'food-dining', date: new Date(new Date().getFullYear(), new Date().getMonth() - 3, 12).toISOString(), description: '3 months ago food', user_id: '' },
    { id: 'f18', type: 'expense', amount: 800, category: 'housing', date: new Date(new Date().getFullYear(), new Date().getMonth() - 3, 1).toISOString(), description: '3 months ago rent', user_id: '' },
  ];
